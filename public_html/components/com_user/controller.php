...
class UserController extends JController
{
	...
	function register_save()
	{
		...
		JRequest::setVar('username', JRequest::getString('email'));
		...
		$return = KRequest::get('server.HTTP_REFERER', 'url');
	...
	function _sendMail(&$user, $password)
	{
		...
		if ( $useractivation == 1 ){
			...
			$message = sprintf ( JText::_( 'SEND_MSG' ), $name, $sitename, $siteURL, $email);
		}
